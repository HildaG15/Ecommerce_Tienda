...
class Conexion{
    ...
    public function __construct(){
        ...
        try{
            ...
            // IMPORTANTE: Configurar SQL_MODE para compatibilidad con consultas GROUP BY
            $this->conect->exec("SET SESSION sql_mode=(SELECT REPLACE(@@sql_mode,'ONLY_FULL_GROUP_BY',''))");
